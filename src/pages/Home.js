  ...
  const loaded = () => (
    <div id="Home">
      ...
      <section className="bio">
        <p> I'm a 30 year old who studied software engineering in 2023. It's something i've long wanted to do and i'm proud of how much I got done. I did the course while working full time which had it's own challenges but thanks to my support network I made it through.</p>

        <p>I'm still working on my skill level, which will be reflected in the ever changing nature of my potfolio. This isn't a CV though, I just want to let you know who I am.</p>

        <p>Just a few days before I started my course, my partner and I adopted a dog! {about.dog} was rescued from a shelter in Spain and she's our princess. She's a galgo, she's almost 2 years old and is equal parts really fast and fast asleep.</p>
